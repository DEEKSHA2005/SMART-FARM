...
def preprocess_data():
    # Load datasets
    crop_data = pd.read_csv(r'C:\Users\deeks\Downloads\FARM-EASY-main\FARM-EASY-main\crop_recommendation.csv')
    fertilizer_data = pd.read_csv(r'C:\Users\deeks\Downloads\FARM-EASY-main\FARM-EASY-main\Fertilizer Prediction.csv')
